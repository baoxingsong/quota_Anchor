...
class Collinearity:
    ...
    def run_anchorwave_pro(self, input_file, output_file, r_value, q_value, maximum_gap_size):
    ...
    def run(self):
        self.run_anchorwave_pro(self.input_file_name, self.output_coll_name, self.R, self.Q, self.maximum_gap_size)
